          ...
          <div className="container relative space-y-10">
            <div>
              <h2 className="mb-2.5 text-3xl font-semibold md:text-5xl">
                The next-gen construction site technology
              </h2>
              <p className="mt-1 max-w-2xl text-muted-foreground md:mt-6">
                {AppInfo.APP_NAME} is the ecosystem that allows construction
                companies on site to take adavantage of BIM on life sites
              </p>
            </div>
            ...
            <div className="grid gap-10 sm:container lg:grid-cols-2">
              <div className="order-1 lg:order-2">
                <h2 className="mb-2.5 mt-8 text-3xl font-semibold md:text-5xl">
                  Your site operating ecosystem
                </h2>
                <p className="mt-1 text-muted-foreground md:mt-6">
                  Harness the power of BIM and AR and DATA to transform your
                  opearations.
                </p>
                <ul className="mt-6 list-none flex-wrap items-center gap-6 space-y-3 md:flex md:space-y-0">
                  {[
                    'Access 3D Informaiton on mobile devices',
                    'Access semantic data available in BIM models',
                    'Overlay BIM models on the real-world site for ease of understanding',
                    'Create notes on top of the BIM models for easy reference',
                    'Use checklist feature to enhance site workflows',
                    'Capture work progress and create reports'
                  ].map((feature) => (
                    <li
                      key={feature}

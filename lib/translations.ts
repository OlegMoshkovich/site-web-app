...
export const translations = {
  en: {
    ...
    mapModalTabOverlay: "Overlay",
    mapOverlayOpacity: "Plan opacity",
    mapOverlayCalibrate: "Calibrate overlay",
    mapOverlayCloseCalibration: "Close calibration",
    mapOverlayCalibrationTitle: "Overlay calibration",
    mapOverlayCalibrationHelp:
      "Select a point, click its position on the plan, then click the matching GPS position on the map.",
    mapOverlayPoint: "Point",
    mapOverlayAnchorPoint: "Anchor point",
    mapOverlayScalePoint: "Scale point",
    mapOverlayAngle: "Angle (degrees)",
    mapOverlayUseMapCenter: "Use map center",
    mapOverlayClickMap: "Click the map to set GPS",
    mapOverlayPlacePlan: "Place plan",
    mapOverlaySaveCalibration: "Save calibration",
    mapOverlayNeedsCalibration:
      "Plan alignment required. Add three calibration points for this plan in Settings.",
    mapOverlayNeedsPlacement: "Click Place plan to preview the current alignment.",
  ...
  de: {
    ...
    mapModalTabPlan: "Plan",
    mapModalTabOverlay: "Overlay",
    mapOverlayOpacity: "Plan-Transparenz",
    mapOverlayCalibrate: "Overlay kalibrieren",
    mapOverlayCloseCalibration: "Kalibrierung schließen",
    mapOverlayCalibrationTitle: "Overlay-Kalibrierung",
    mapOverlayCalibrationHelp:
      "Wählen Sie einen Punkt, klicken Sie seine Position im Plan an und klicken Sie dann die passende GPS-Position auf der Karte.",
    mapOverlayPoint: "Punkt",
    mapOverlayAnchorPoint: "Ankerpunkt",
    mapOverlayScalePoint: "Skalierungspunkt",
    mapOverlayAngle: "Winkel (Grad)",
    mapOverlayUseMapCenter: "Kartenmitte übernehmen",
    mapOverlayClickMap: "Karte anklicken, um GPS zu setzen",
    mapOverlayPlacePlan: "Plan platzieren",
    mapOverlaySaveCalibration: "Kalibrierung speichern",
    mapOverlayNeedsCalibration:
      "Planausrichtung erforderlich. Fügen Sie in den Einstellungen drei Kalibrierungspunkte für diesen Plan hinzu.",
    mapOverlayNeedsPlacement: "Klicken Sie auf Plan platzieren, um die aktuelle Ausrichtung zu prüfen.",

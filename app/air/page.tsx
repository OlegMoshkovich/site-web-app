...
export default function AILabPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EDE8E0]">
      {/* Navigation */}
      <nav className="w-full bg-[#E1DECF]">
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-300 bg-[#E1DECF]">
      ...
      <section className="w-full min-h-screen bg-[#1E2938] px-4 sm:px-6 lg:px-8 flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-white">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 tracking-wide">
